'use strict';
 ...
 // the angular module is embodied in the javascript object called app, and it is given the name confusionApp
 var app = angular.module('confusionApp', []);

 // the app.controller is given the name menuController
